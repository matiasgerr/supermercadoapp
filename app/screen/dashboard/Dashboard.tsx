...
const PanelGestion: React.FC<PanelGestionProps> = ({
  ...
  const [localSeleccionadoId, setLocalSeleccionadoId] = useState<number | null>(
    null,
  );
    ...
    <div className="flex h-screen bg-white">
        ...
        <div className="mt-4 flex flex-col gap-2">
          ...
          {categoriaSeleccionada && comercios.length > 0 ? (
            comercios.map((local) => (
              <div
                key={local.id}
                className={`flex items-center justify-between transition ${localSeleccionadoId === local.id ? "bg-gray-700 font-bold" : "hover:bg-gray-800"}`}
              >
                <button
          ...
          <div className="text-sm text-gray-400 p-2"> Seleccione una categoria para ver sus locales</div>
        )}
        </div>
      ...
      <div className="flex-1 p-8 overflow-y-auto">
        <h2 className="text-3xl font-bold text-gray-800 mb-6 capitalize">
          {categoriaSeleccionada
            ? `Gestión de ${categoriaSeleccionada?.nombre}`
          ...
          <>
            ...
            <div className="bg-gray-50 p-6 rounded-xl mb-8 border border-gray-200">
              <h3 className="font-semibold mb-4 text-black">
                Registrar Nuevo Local en {categoriaSeleccionada?.nombre}
              </h3>
            ...
            <div className="bg-white rounded-lg shadow border border-gray-100">
              <div className="p-4 border-b bg-gray-50 flex justify-between items-center">
                <h3 className="font-bold text-black">
                  {localActivo
                    ? `Productos de: ${localActivo?.nombre}`
                    : "Selecciona un local"}
                </h3>
              </div>
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  {localActivo &&
                  localActivo.productos &&
                  localActivo.productos.length > 0 ? (
                    ...
                    <tr>
                      <td
                        className="p-10 border text-gray-400 text-center"
                        colSpan={4}
                      >
                        {localSeleccionadoId
